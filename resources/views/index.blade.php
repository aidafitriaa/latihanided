                                            ...
                                            <div class="single-mega cn-col-4">
                                                ...
                                                <div class="single-blog-post small-featured-post d-flex">
                                                    <div class="post-thumb">
                                                        <a href="#"><img src="{{('assets/frontend/img/bg-img/23.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="post-data">
                                                ...
                                                <div class="single-blog-post small-featured-post d-flex">
                                                    <div class="post-thumb">
                                                        <a href="#"><img src="{{('assets/frontend/img/bg-img/24.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="post-data">
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="single-blog-post featured-post">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{('assets/frontend/img/bg-img/16.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-data">
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <div class="single-blog-post featured-post-2">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{('assets/frontend/img/bg-img/17.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <div class="post-meta">
                            ...
                            <div class="single-blog-post featured-post-2">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{('assets/frontend/img/bg-img/18.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <div class="post-meta">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        <div class="post-thumb">
                            <a href="#"><img src="{{('assets/frontend/img/bg-img/19.jpg')}}" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-catagory">Finance</a>
                            <div class="post-meta">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        <div class="post-thumb">
                            <a href="#"><img src="{{('assets/frontend/img/bg-img/20.jpg')}}" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-catagory">Politics</a>
                            <div class="post-meta">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        <div class="post-thumb">
                            <a href="#"><img src="{{('assets/frontend/img/bg-img/21.jpg')}}" alt=""></a>
                        </div>
                        <div class="post-data">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        <div class="post-thumb">
                            <a href="#"><img src="{{('assets/frontend/img/bg-img/22.jpg')}}" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-catagory">Finance</a>
                            <div class="post-meta">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-post style-3">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{('assets/frontend/img/bg-img/12.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <a href="#" class="post-title">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-post style-3">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{('assets/frontend/img/bg-img/13.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <a href="#" class="post-title">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-post style-3">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{('assets/frontend/img/bg-img/14.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <a href="#" class="post-title">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-post style-3">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{('assets/frontend/img/bg-img/15.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <a href="#" class="post-title">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-5 col-lg-3">
                    ...
                    <div class="single-blog-post style-2">
                        <div class="post-thumb">
                            <a href="#"><img src="{{('assets/frontend/img/bg-img/10.jpg')}}" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-title">
                                <h6>Orci varius natoque penatibus et magnis</h6>
                    ...
                    <div class="single-blog-post style-2">
                        <div class="post-thumb">
                            <a href="#"><img src="{{('assets/frontend/img/bg-img/11.jpg')}}" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-title">
                                <h6>Orci varius natoque penatibus et magnis</h6>
